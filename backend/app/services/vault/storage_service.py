...
from app.core.supabase_storage_client import SupabaseStorageClient
...
class VaultStorageService:
    ...
    def upload_pdf(self, *, storage_path: str, content: bytes) -> str:
        ...
        if not self._client.configured:
            logger.error("vault_storage_not_configured")
        ...
        try:
            ...
            logger.error("vault_storage_upload_error", extra={"path": storage_path})
    ...
    def create_signed_download_url(self, *, storage_path: str, expires_in: int = 3600) -> str:
        ...
        try:
            ...
            logger.error("vault_storage_sign_error", extra={"path": storage_path})
            raise VaultStorageError("Stockage temporairement indisponible") from exc
